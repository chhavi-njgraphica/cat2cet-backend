...
<div class="row mt-4">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{(isset($college->id)) ? route('backend.xat-colleges.update',[$college->id]) : route('backend.xat-colleges.store') }}">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select name="percentile_between" id="" class="form-select" required>
                                    ...
                                    <option value="below-60" {{!empty($college) && $college->percentile_between == 'below-50' ? 'selected' : ''}}>Below 60% tile</option>
                                </select>
                            </div>
                        </div>
