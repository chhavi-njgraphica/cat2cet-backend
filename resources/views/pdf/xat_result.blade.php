...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr
                <td>{{ $result['data']['details']['Candidate Name'] ?? 'N/A' }}</td>
                <td>{{ $result['data']['details']['XAT ID'] ?? 'N/A' }}</td>
                <td>{{ $result['data']['details']['TC Name'] ?? 'N/A' }}</td>
            </tr>
        </table>
    </div>
